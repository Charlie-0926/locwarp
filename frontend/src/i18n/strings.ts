...
export const STRINGS = {
  ...
  'panel.spiral_radius': { zh: '繞圈半徑 (m)', en: 'Spiral radius (m)' },
  'panel.spiral_spacing': { zh: '線距 (m)', en: 'Spacing (m)' },
  ...
  'panel.waypoints_run_start': { zh: '本次從這裡開始跑,不改變路徑順序', en: 'Start this run here without changing route order' },
  'panel.waypoints_run_start_short': { zh: '起跑', en: 'Run' },
  'panel.waypoints_run_start_selected': { zh: '本次起跑', en: 'Run start' },
  ...
  'panel.jump_mode_tooltip': { zh: '不走路、直接逐點瞬移；所有等待都在到站後進行', en: 'Skip walking and teleport stop-to-stop; all dwell happens after arrival' },
  'panel.jump_dwell_motion': { zh: '等待後直線移動', en: 'Move straight after waiting' },
  'panel.jump_dwell_motion_tooltip': { zh: '等待完成後隨機選一個方向，以固定 15 km/h 直線移動', en: 'After waiting, choose one random bearing and move straight at a fixed 15 km/h' },
  'panel.jump_extra_wait': { zh: '到站後先等待', en: 'Wait after arrival' },
  'panel.jump_extra_wait_tooltip': { zh: '到達路徑點後，在原地等待再開始直線移動的秒數', en: 'Seconds to wait at the arrival point before straight-line movement starts' },
  'panel.jump_move_seconds': { zh: '直線移動時間', en: 'Straight movement time' },
  'panel.jump_move_seconds_tooltip': { zh: '以固定 15 km/h 直線移動的秒數', en: 'Seconds to move straight at the fixed 15 km/h speed' },
  'panel.jump_dwell_total_enabled': { zh: '先等待 {n} 秒，再以 15 km/h 移動 {m} 秒；共 {total} 秒', en: 'Wait {n}s, then move at 15 km/h for {m}s; {total}s total' },
  'panel.jump_dwell_total_disabled': { zh: '到站後原地等待 {n} 秒', en: 'Wait at the arrival point for {n}s' },
  'panel.apply_jump_settings': { zh: '套用到站後設定', en: 'Apply arrival settings' },
  'panel.apply_jump_settings_success': { zh: '設定已套用，下一個停靠點起生效', en: 'Settings applied; effective from the next stop' },
  ...
  'loop.lap_hint_single': { zh: '單趟', en: 'Single pass' },

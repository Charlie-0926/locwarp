...
export const STRINGS = {
  ...
  'panel.jump_random_walk': { zh: '等待期間隨機移動', en: 'Random walk during dwell' },
  'panel.jump_random_walk_tooltip': { zh: '跳躍到目標點後，在等待秒數內會在半徑內進行隨機漫步', en: 'Wander randomly within the radius while dwelling at the waypoint' },

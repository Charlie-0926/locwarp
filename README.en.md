...
Multi-point Route mode has a **Point-to-point jump** checkbox. The device teleports immediately from stop to stop; all dwell happens after arrival. The configurable **Wait after arrival** defaults to 6 seconds and is stored in localStorage.
